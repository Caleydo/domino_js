 ...
 */
define(['../caleydo/data', 'd3', 'jquery', '../caleydo/event', '../caleydo-selectioninfo/main', './board', '../caleydo/idtype', './toolbar', 'bootstrap', 'font-awesome'], function (data, d3, $, events, selectionInfo, boards, idtypes, links) {
  'use strict';
